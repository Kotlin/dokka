...
Please see the [Dokka Gradle example project](https://github.com/Kotlin/dokka/kotlin-examples/tree/master/examples/gradle/dokka-gradle-example) for an example.
