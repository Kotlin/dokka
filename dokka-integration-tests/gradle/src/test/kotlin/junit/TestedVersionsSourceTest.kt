 ...
 * ```
 * expected: <"... kgp: 1.9.25, 2.0.21, 2.1.21, 2.2.21, 2.3.20-RC2 ...">
 * but was:  <"... kgp: 1.9.25, 2.0.21, 2.1.21, 2.2.21, 2.3.20-RC2, 2.4.0 ...">
 * ```
...
class TestedVersionsSourceTest {
    ...
    fun `test default versions`() {
        ...
        actual shouldBe """
            ...
            kgp: 1.9.25, 2.0.21, 2.1.21, 2.2.21, 2.3.20-RC2
        """.trimIndent()
    }
