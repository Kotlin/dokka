    ...
    fun `should include all icons`() {
        ...
        testInline(
            ...
            renderingStage = { _, _ ->
                ...
                assertEquals(27, navIconAssets.size)
                ...
                assertEquals("ui-kit/assets/check.svg", navIconAssets[6])
                ...
                assertEquals("ui-kit/assets/cross.svg", navIconAssets[11])
                assertEquals("ui-kit/assets/enum-kotlin.svg", navIconAssets[12])
                assertEquals("ui-kit/assets/enum.svg", navIconAssets[13])
                assertEquals("ui-kit/assets/exception-class.svg", navIconAssets[14])
                assertEquals("ui-kit/assets/field-value.svg", navIconAssets[15])
                assertEquals("ui-kit/assets/field-variable.svg", navIconAssets[16])
                assertEquals("ui-kit/assets/filter.svg", navIconAssets[17])
                assertEquals("ui-kit/assets/function.svg", navIconAssets[18])
                assertEquals("ui-kit/assets/go-to-top-icon.svg", navIconAssets[19])
                assertEquals("ui-kit/assets/homepage.svg", navIconAssets[20])
                assertEquals("ui-kit/assets/interface-kotlin.svg", navIconAssets[21])
                assertEquals("ui-kit/assets/interface.svg", navIconAssets[22])
                assertEquals("ui-kit/assets/object.svg", navIconAssets[23])
                assertEquals("ui-kit/assets/placeholder.svg", navIconAssets[24])
                assertEquals("ui-kit/assets/theme-toggle.svg", navIconAssets[25])
                assertEquals("ui-kit/assets/typealias-kotlin.svg", navIconAssets[26])
            }
        }
    }
