    ...
    fun `should include all icons`() {
        ...
        testInline(
            ...
            renderingStage = { _, _ ->
                ...
                assertEquals(30, navIconAssets.size)
                ...
                assertEquals("ui-kit/assets/anchor-copy-icon.svg", navIconAssets[2])
                assertEquals("ui-kit/assets/annotation-kotlin.svg", navIconAssets[3])
                assertEquals("ui-kit/assets/annotation.svg", navIconAssets[4])
                assertEquals("ui-kit/assets/arrow-down.svg", navIconAssets[5])
                assertEquals("ui-kit/assets/burger.svg", navIconAssets[6])
                assertEquals("ui-kit/assets/check.svg", navIconAssets[7])
                assertEquals("ui-kit/assets/checkbox-off.svg", navIconAssets[8])
                assertEquals("ui-kit/assets/checkbox-on.svg", navIconAssets[9])
                assertEquals("ui-kit/assets/class-kotlin.svg", navIconAssets[10])
                assertEquals("ui-kit/assets/class.svg", navIconAssets[11])
                assertEquals("ui-kit/assets/copy-icon.svg", navIconAssets[12])
                assertEquals("ui-kit/assets/cross.svg", navIconAssets[13])
                assertEquals("ui-kit/assets/enum-kotlin.svg", navIconAssets[14])
                assertEquals("ui-kit/assets/enum.svg", navIconAssets[15])
                assertEquals("ui-kit/assets/exception-class.svg", navIconAssets[16])
                assertEquals("ui-kit/assets/field-value.svg", navIconAssets[17])
                assertEquals("ui-kit/assets/field-variable.svg", navIconAssets[18])
                assertEquals("ui-kit/assets/filter.svg", navIconAssets[19])
                assertEquals("ui-kit/assets/function.svg", navIconAssets[20])
                assertEquals("ui-kit/assets/go-to-top-icon.svg", navIconAssets[21])
                assertEquals("ui-kit/assets/homepage.svg", navIconAssets[22])
                assertEquals("ui-kit/assets/interface-kotlin.svg", navIconAssets[23])
                assertEquals("ui-kit/assets/interface.svg", navIconAssets[24])
                assertEquals("ui-kit/assets/object.svg", navIconAssets[25])
                assertEquals("ui-kit/assets/placeholder.svg", navIconAssets[26])
                assertEquals("ui-kit/assets/success-icon.svg", navIconAssets[27])
                assertEquals("ui-kit/assets/theme-toggle.svg", navIconAssets[28])
                assertEquals("ui-kit/assets/typealias-kotlin.svg", navIconAssets[29])
            }
        }
    }
