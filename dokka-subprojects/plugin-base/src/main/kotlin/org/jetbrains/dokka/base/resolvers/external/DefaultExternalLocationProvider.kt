...
import org.jetbrains.dokka.base.renderers.toLocationString
...
public open class DefaultExternalLocationProvider(
    ...
    override fun resolve(dri: DRI): String? {
        externalDocumentation.packageList.locations[dri.toLocationString()]?.let { path -> return "$docURL$path" }
