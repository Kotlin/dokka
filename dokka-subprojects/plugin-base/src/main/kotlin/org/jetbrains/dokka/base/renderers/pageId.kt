...
internal fun Set<DRI>.shortenToUrl() = sortedBy { it.toUrlString() }.joinToString().hashCode()
 ...
 */
private fun pageId(dri: DRI, sourceSets: Set<DisplaySourceSet>): String = "${dri.toUrlString()}/${sourceSets.shortenToUrl()}"
