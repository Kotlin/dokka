...
// This variable is set by KotlinPlaygroundSamplesInstaller when the user provides a custom server URL
...
const initPlayground = (theme) => {
    ...
    if (kotlinPlaygroundServer != null) options.server = kotlinPlaygroundServer;
