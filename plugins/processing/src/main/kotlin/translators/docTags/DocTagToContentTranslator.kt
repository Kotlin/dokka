...
object DocTagToContentTranslator : CommentsToContentTranslator {
    override fun buildContent(
        ...
        fun buildChildren(docTag: DocTag, newStyles: Set<Style> = emptySet(), newExtras: SimpleAttr? = null) =
            docTag.children.flatMap { tag ->
                buildContent(tag, dci, sourceSets, styles + newStyles, newExtras?.let { extras + it } ?: extras)
            }
