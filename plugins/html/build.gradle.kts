...
val projectDistDir = project(":plugins:html:frontend").file("dist")
val generateFrontendFiles = tasks.getByPath(":plugins:html:frontend:generateFrontendFiles")
...
registerDokkaArtifactPublication("htmlPlugin") {
