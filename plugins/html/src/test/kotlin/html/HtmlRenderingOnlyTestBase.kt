...
import org.jetbrains.dokka.html.renderers.DefaultTabSortingStrategy
...
abstract class HtmlRenderingOnlyTestBase : RenderingOnlyTestBase<Element>() {
    ...
    override val context = MockContext(
        ...
        DokkaHtml().htmlPreprocessors to { RootCreator },
        ...
        DokkaHtml().tabSortingStrategy to { DefaultTabSortingStrategy() },
