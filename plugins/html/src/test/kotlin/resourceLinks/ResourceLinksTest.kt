...
import org.jetbrains.dokka.html.renderers.TEMPLATE_REPLACEMENT
...
class ResourceLinksTest : BaseAbstractTest() {
    class TestResourcesAppenderPlugin(val resources: List<String>) : DokkaPlugin() {
        ...
        val appender by extending {
            plugin<DokkaHtml>().htmlPreprocessors with TestResourcesAppender(resources)
        }
    }
        ...
        val configuration = dokkaConfiguration {
            ...
            pluginsConfigurations = mutableListOf(
                PluginConfigurationImpl(
                    DokkaHtml::class.java.canonicalName,
                    DokkaConfiguration.SerializationFormat.JSON,
                    toJsonString(
                        DokkaHtmlConfiguration(
