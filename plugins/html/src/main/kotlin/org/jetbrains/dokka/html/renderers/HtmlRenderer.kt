...
import org.jetbrains.dokka.html.renderers.innerTemplating.DefaultTemplateModelMerger
import org.jetbrains.dokka.html.renderers.innerTemplating.DefaultTemplateModelFactory
import org.jetbrains.dokka.html.renderers.innerTemplating.DokkaTemplateTypes
import org.jetbrains.dokka.html.renderers.innerTemplating.HtmlTemplater
...
private typealias SerializedBeforeAndAfter = Pair<String, String>
...
open class HtmlRenderer(
    ...
    override val preprocessors = context.plugin<DokkaHtml>().query { htmlPreprocessors }

    private val tabSortingStrategy = context.plugin<DokkaHtml>().querySingle { tabSortingStrategy }
