...
internal abstract class PluginFeaturesService : BuildService<PluginFeaturesService.Params> {
    ...
    interface Params : BuildServiceParameters {
        /** Whether DGP should use V2 (Dokkatoo). Otherwise, fallback to DGP-classic. */
    ...
    fun logV1Warning() {
        if (!v1WarningLogged) {
            logger.warn(
                """
                |⚠ Warning: Dokka Gradle Plugin classic mode is enabled
                |
                |  Classic mode is deprecated, and will be removed in Dokka version 2.0.20.
                |
    ...
    fun logV2Message() {
        println("logV2Message -- suppressV2PluginMessage=$suppressV2PluginMessage, v2MessageLogged=$v2MessageLogged")
