...
import org.jetbrains.dokka.gradle.internal.PluginFeaturesService.Companion.V2_PLUGIN_MESSAGE_SUPPRESSED_FLAG

fun Project.enableV2Plugin(
    suppressV2Message: Boolean = true
): Project {
    extensions.extraProperties.set(V2_PLUGIN_ENABLED_FLAG, true)
    extensions.extraProperties.set(V2_PLUGIN_MESSAGE_SUPPRESSED_FLAG, suppressV2Message)
    return this
}
